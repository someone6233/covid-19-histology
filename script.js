...
function setupTissueScreen() {
  const questions = [
    ...
    { prompt: "What is an alveolus?", options: ["A large airway tube in the lungs", "A tiny air sac in the lungs", "A type of white blood cell in the lungs", "A muscle in the chest in the lungs"], correct: 1, explain: "Alveoli are the tiny, thin-walled sacs at the end of the airway where gas exchange happens." },
...
const VIDEO_CHECKPOINTS = [
  ...
  { time: 80, prompt: "Why does someone with damaged alveoli often feel short of breath?", options: ["Their bones are weaker", "Less oxygen is reaching their blood", "Their eyesight changes"], correct: 1, explain: "If oxygen can't cross into the blood efficiently, the body doesn't get enough oxygen — leading to shortness of breath." }
];
